...
def test_github_url_preserves_enterprise_https_url():
    assert _normalize_github_url("https://github.example.com/") == "https://github.example.com"


@pytest.mark.parametrize("url", ["http://github.com", "https://user:secret@github.com", "not a host"])
