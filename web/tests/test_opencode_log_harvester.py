...
INFO_LINE = 'timestamp=2026-07-27T02:29:05Z level=INFO run=ddd message="loop" session.id=ses_072\n'
...
def test_surfaces_new_stream_and_models_dev_errors(harvester, caplog):
    ...
    assert (
        "kind=api" in joined and "GLM-5.2-FP8" in joined and "GatewayTimeout" in joined
    )
