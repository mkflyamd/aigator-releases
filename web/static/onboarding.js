...
const OB_STEPS = [
  /* 0 — welcome */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Your <strong>Integrated Work Environment</strong> — all your tools in one place</li><li>Email, calendar, Jira, Confluence, Teams and more</li><li>Try each skill for real using the <strong>prompt bar</strong> on the right</li></ul>',
    skillId: null,
    simulated: null,
    tryPrompt: null,
  },
  ...
  /* 1 — connect */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Click the <strong>gear icon</strong> in the top-right to open Settings</li><li>Connect <strong>Microsoft 365</strong>, <strong>Jira</strong>, <strong>Confluence</strong>, and more</li><li>The more you connect, the more Gator can do for you</li></ul>',
    skillId: null,
    simulated: null,
    tryPrompt: null,
  },
  ...
  /* 2 — call a skill */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Type <code>/</code> followed by the skill name in the prompt bar</li><li><code>/gator</code> is your general-purpose assistant</li><li>Or click the <strong>+</strong> button to browse available skills</li></ul>',
    skillId: null,
    simulated: null,
  ...
  /* 2 — email */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Use <code>/email</code> to check your <strong>Outlook inbox</strong></li><li>Summarises unread messages for quick triage</li><li>Search for emails by sender or topic</li></ul>',
    skillId: 'email',
  ...
  /* 2 — calendar */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Use <code>/calendar</code> to see <strong>today\'s meetings</strong></li><li>Find free slots and check availability</li><li>Schedule new meetings right here</li></ul>',
    skillId: 'calendar',
  ...
  /* 3 — teams */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Use <code>/teams</code> to read your <strong>messages and channels</strong></li><li>Send new messages to people or channels</li><li>Post to saved messages for quick notes</li></ul>',
    skillId: 'teams',
  ...
  /* 4 — jira */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Use <code>/jira</code> to list your <strong>open tickets</strong></li><li>Get full details on any issue by key</li><li>Filter by project, status, or assignee</li></ul>',
    skillId: 'jira',
  ...
  /* 5 — confluence */
  {
    ...
    act: 'read',
    description:
      '<ul class="ob-bullets"><li>Use <code>/confluence</code> to search your <strong>spaces</strong></li><li>Find docs, RFCs, and runbooks in seconds</li><li>Get page summaries without switching apps</li></ul>',
    skillId: 'confluence',
  ...
  /* 7 — jira-write */
  {
    ...
    act: 'write',
    description:
      '<ul class="ob-bullets"><li>Use <code>/jira</code> to <strong>draft tickets</strong> from a description</li><li>Gator fills in project, type, and priority</li><li>Review before submitting</li></ul>',
    skillId: 'jira',
  ...
  /* 8 — confluence-write */
  {
    ...
    act: 'write',
    description:
      '<ul class="ob-bullets"><li>Use <code>/confluence</code> to <strong>create or update</strong> pages</li><li>Gator drafts the content, you choose the space</li><li>Great for meeting notes, status updates, RFCs</li></ul>',
    skillId: 'confluence',
  ...
  /* 9 — document */
  {
    ...
    act: 'write',
    description:
      '<ul class="ob-bullets"><li>Use <code>/docx</code> for Word, <code>/ppt</code> for PowerPoint, <code>/excel</code> for Excel</li><li>Just describe what you need in plain language</li><li>Gator generates the file ready to download</li></ul>',
    skillId: 'docx',
    tryPrompt:
      '/docx Create a one-page project status report template with sections for highlights, risks, and next steps',
    simulated: [
  ...
  /* 11 — done */
  {
    ...
    act: 'done',
    description:
      '<ul class="ob-bullets"><li>Type <code>/skill</code> to activate any skill or pick an action</li><li>Use <code>@</code> to mention a colleague</li><li><strong>Pin</strong> items for context, <code>Shift+{</code> to reference</li><li>Explore the <strong>skill bar</strong> on the left for more</li></ul>',
    skillId: null,
    simulated: null,
    tryPrompt: null,
  },
...
function _obActLabel(act) {
  switch (act) {
    case 'read':
      return { text: 'Read', color: 'var(--text-sub)' };
    case 'pin':
      return { text: 'Pin', color: '#f59e0b' };
    case 'write':
      return { text: 'Write', color: '#22c55e' };
    default:
      return { text: '', color: 'var(--text-sub)' };
  }
}
...
function _obRenderStepContent(step, currentStep) {
  ...
  if (step.tryPrompt) {
    tryHtml =
      '<div class="ob-try-wrapper"><span class="ob-try-label">Try it</span><hr class="ob-try-divider"/><button class="ob-try-btn" id="ob-try" data-prompt="' +
      step.tryPrompt.replace(/"/g, '&quot;') +
      '">' +
      step.tryPrompt +
      '</button></div>';
  }
  ...
  return [
    ...
    '<div class="ob-step-icon" style="background:' +
      bgTint +
      ';border-color:' +
      step.color +
      '30">',
...
function _obRenderCurrentStep(container) {
  ...
  if (step.id === 'connect') {
    var settingsBtn =
      document.getElementById('dock-settings') || document.getElementById('settings-trigger');
    if (settingsBtn) {
      setTimeout(function () {
...
function _obClearPinCoaching() {
  ...
  document.querySelectorAll('.ob-coach-bubble').forEach(function (el) {
    el.remove();
  });
}
...
function _obShowCoachBubble(targetEl, text, position) {
  ...
  bubble.innerHTML =
    '<div class="ob-coach-bubble-caret"></div><span>' +
    text +
    '</span><button class="ob-coach-close">&times;</button>';
    ...
    if (thirdPane && thirdPane.classList.contains('is-open')) {
      ...
      var showStep2Coach = function () {
        ...
        if (firstItem) {
          ...
          _obShowCoachBubble(
            firstItem,
            '<strong>Right-click</strong> this email \u2192 <em>Pin to tab</em>',
            'bottom',
          );
        }
      };
      ...
      if (!pinBadge.classList.contains('hidden')) {
        ...
        if (tryArea) {
          ...
          tryArea.innerHTML =
            ...
            '<button class="ob-try-btn" id="ob-pin-try-btn" data-prompt="' +
            prompt +
            '">' +
            prompt +
            '</button>' +
...
function _obHibernate(container) {
  ...
  var gatorHtml =
    typeof gatorEmptyState === 'function'
...
function _obShowHelpCoachMark() {
  ...
  var bubble = _obShowCoachBubble(
    settingsBtn,
    '<strong>Restart Tour</strong> by visiting the <strong>Help</strong> section',
    'left',
  );
  if (!bubble) return;
