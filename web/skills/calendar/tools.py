...
def _parse_email_list(addresses) -> list[str]:
    """Normalize attendee input from the LLM into a flat list of individual email strings.

    Accepts: None, a bare comma/space-separated string, a list of strings, or a
    list where each item is itself a comma/space-separated string.
    """
    if not addresses:
        return []
    ...
    for item in addresses:
        if isinstance(item, str):
            flat.extend(a for a in re.split(r"[,\s]+", item) if a)
    return flat
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "body": {"type": "string", "description": "New meeting body/agenda (plain text)"},
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "attendees": {"type": "array", "items": {"type": "string"}, "description": "List of required attendee email addresses"},
                "optional_attendees": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "List of optional attendee email addresses",
                },
                "body": {"type": "string", "description": "Optional meeting description or agenda"},
