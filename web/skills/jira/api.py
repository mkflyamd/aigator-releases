...
def jira_api(method: str, path: str, body: dict | None = None, api_version: str = "2") -> dict:
    auth_header, base, is_cloud = _jira_auth()
    version = api_version if is_cloud else "2"
    url = f"{base}/rest/api/{version}/{path.lstrip('/')}"
