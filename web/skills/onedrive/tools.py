    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "drive_id": {"type": "string", "description": "Drive ID for SharePoint or shared drives. When provided, routes to /drives/{drive_id}/... instead of /me/drive."},
                "folder_id": {"type": "string", "description": "Item ID of a specific folder on the given drive. Use together with drive_id to list a known SharePoint folder directly."},
            },
            "required": [],
        },
    },
